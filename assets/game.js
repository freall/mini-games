...
(function () {
  ...
  var flashEl = $('flash');
  var bannerEl = $('banner');
  var bannerTxt = $('bannerTxt');
  var bannerSub = $('bannerSub');
  var ovStart = $('ovStart');
  var ovPause = $('ovPause');
  var ovOver = $('ovOver');
  var uiScore = $('uiScore'), uiBest = $('uiBest'), uiLevel = $('uiLevel'),
    uiLife = $('uiLife'), uiCombo = $('uiCombo'), uiAmmo = $('uiAmmo'),
    uiAmmoBar = $('uiAmmoBar'), uiComboBox = $('uiComboBox'), uiComboBarI = $('uiComboBar').firstElementChild,
    uiOrders = $('uiOrders');
